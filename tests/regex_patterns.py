order_create_pattern = (
    ...
    r'example:date_of_order=".*", example:bor_start_date="None", '
    ...
    r'auth:id="1", auth:password=".*", auth:last_login=".*", '
    ...
    r'  wasAttributedTo\(example:Student-1-.*, '
    r'auth:User-1-.*\)\n'

    r'  hadMember\(example:Borrowing-2-.*, '
    r'example:Student-1-.*\)\n'
    ...
    r'  hadMember\(example:Borrowing-2-.*, '
    r'example:Borrowing_ordered_books-2-.*\)\n'
    ...
    r'  hadMember\(example:Borrowing-2-.*, '
    r'example:Borrowing_borrowed_books-2-.*\)\n'

    r'  wasGeneratedBy\(example:Borrowing-2-.*, '
    r'django:foo22-.*, -\)\n'
    ...
    r'  hadMember\(example:Borrowing_ordered_books-2-.*, '
    r'example:Book-1-.*\)\n'
    ...
    r'<example\.views\.OrderCreateView object at .*\)", '
    ...
    r'  wasAssociatedWith\(django:foo22-.*, '
    r'auth:User-1-.*, -\)\n'
...
r'document\n'
    ...
    r'  hadMember\(example:Borrowing-1-.*, '
    r'example:Student-1-.*\)\n'
    ...
    r'  hadMember\(example:Borrowing-1-.*, '
    r'example:Borrowing_ordered_books-1-.*\)\n'
    ...
    r'  hadMember\(example:Borrowing_ordered_books-1-.*, '
    r'example:Book-1-.*\)\n'
    ...
    r'  hadMember\(example:Borrowing-1-.*, '
    r'example:Borrowing_borrowed_books-1-.*\)\n'

    r'  wasDerivedFrom\(example:Borrowing-1-.*, '
    r'example:Borrowing-1-.*, -, -, -\)\n'
    ...
    r'  agent\(auth:User-2-.*, '
    r'\[prov:type="auth:<class \'django\.contrib\.auth\.models\.User\'>", '
    r'auth:id="2", auth:password="[^"]+", auth:last_login=".*", '
    r'auth:is_superuser="False", auth:username="Librarian", auth:first_name="", auth:last_name="", '
    r'auth:email="", auth:is_staff="False", auth:is_active="True", '
    r'auth:date_joined=".*"\]\)\n'

    r'  wasAttributedTo\(example:Librarian-1-.*, '
    r'auth:User-2-.*\)\n'

    r'  hadMember\(example:Borrowing-1-.*, '
    r'example:Librarian-1-.*\)\n'
    ...
    r'  wasGeneratedBy\(example:Borrowing-1-.*, '
    r'django:foo23-.*, -\)\n'
    ...
    r'  wasDerivedFrom\(example:Book-1-.*, '
    r'example:Book-1-.*, -, -, -\)\n'

    r'  wasGeneratedBy\(example:Book-1-.*, '
    r'django:foo23-.*, -\)\n'
    ...
    r'  wasDerivedFrom\(example:Book-2-.*, '
    r'example:Book-2-.*, -, -, -\)\n'

    r'  wasGeneratedBy\(example:Book-2-.*, '
    r'django:foo23-.*, -\)\n'

    r'  hadMember\(example:Borrowing_borrowed_books-1-.*, '
    r'example:Book-1-.*\)\n'
    ...
    r'  wasAssociatedWith\(django:foo23-.*, '
    r'auth:User-2-.*, -\)\n'
    r'endDocument'
)
